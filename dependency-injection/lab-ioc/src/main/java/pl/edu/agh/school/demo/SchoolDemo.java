...
public class SchoolDemo {
    ...
    @Inject
    public SchoolDemo(Logger logger, School school, School school1) {
        this.logger = logger;
        this.school = school;
        this.logger.registerSerializer(new ConsoleMessageSerializer());
        this.logger.registerSerializer(new FileMessageSerializer("logfile.log"));
//        var persistentManager = new SerializablePersistenceManager();
//        persistentManager.setClassStorageFileName("classess.dat");
